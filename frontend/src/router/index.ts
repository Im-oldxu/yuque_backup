  ...
  routes: [
    { path: '/auth', name: 'auth', component: () => import('@/views/AuthView.vue'), meta: { public: true, title: '管理员入口' } },
    {
      ...
      children: [
        ...
        { path: 'jobs', redirect: '/jobs/manual' },
        { path: 'jobs/manual', name: 'manual-backup', component: () => import('@/views/JobsView.vue'), props: { mode: 'manual' }, meta: { title: '手动备份', activePath: '/jobs/manual' } },
        { path: 'jobs/scheduled', name: 'scheduled-backup', component: () => import('@/views/JobsView.vue'), props: { mode: 'scheduled' }, meta: { title: '定时备份', activePath: '/jobs/scheduled' } },
