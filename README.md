...
Yuque Backup 是面向单管理员、自托管场景的语雀只读备份系统。v1.1.1 提供多凭据管理与编辑、知识库发现与选择、带额度预估的手动/定时备份向导、持久化备份队列、增量版本与附件保存、安全预览、实时任务活动、删除保留及本地离线浏览。
...
- `需求文档.md`、`技术方案文档.md`、`API 接口文档.md`：v1.1.1 产品、技术和接口契约。
...
- 运行：v1.0.0 已完成 API live/ready、worker 心跳、真实 API 初始化/登录/退出、Cookie/CSRF 及桌面和移动端浏览器联调；v1.1.1 沿用相同部署拓扑。
